    ...
    public function toArray(Request $request): array
    {
        return [
            ...
            'medical_histories' => $this->medical_histories ? [
                'id' => $this->medical_histories->id,
                'description' => $this->medical_histories->description,
                'diagnosis' => $this->medical_histories->diagnosis,
                'treatment' => $this->medical_histories->treatment,
                'created_at' => $this->medical_histories->created_at,
                'updated_at' => $this->medical_histories->updated_at,
            ] : null,
