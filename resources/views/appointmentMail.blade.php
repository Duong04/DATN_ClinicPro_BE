        ...
        <div style="background-color: #fff; padding: 45px">
            ...
            <div class="body">
                ...
                <p style="margin-top: 15px; font-size: 16px">
                    Chúng tôi xác nhận cuộc hẹn của bạn vào ngày <b>{{ $date->toDateString() }}</b> lúc
                    <b>{{ $date->toTimeString() }}</b> . Vui lòng lên kế hoạch đến <b>{{ $location }}</b> ít nhất 20
                    phút trước cuộc hẹn theo lịch trình của bạn để có thời gian đăng ký và mọi thủ tục giấy tờ cần
                    thiết.
                </p>
                <p style="margin-top: 15px; font-size: 16px">
